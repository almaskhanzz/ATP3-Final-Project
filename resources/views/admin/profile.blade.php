...
<div class="w3-content"> 
    ...
    {{csrf_field()}}
        ...
        <div class="w3-section">
            <label>Name</label>
            <input type="text" name="name" class="w3-input w3-border w3-hover-border-black" placeholder="Please enter First name" value="{{$admin->name}}"/>
        </div>
        <div class="w3-section">
            <label>Email</label>
            <input type="text" name="email" class="w3-input w3-border w3-hover-border-black" placeholder="Please enter email name" value="{{$admin->email}}"/>
        </div>
