...
<div class="w3-content"> 
    <div class="w3-center w3-padding-64" id="login">
        <span class="w3-xlarge w3-bottombar w3-border-dark-grey w3-padding-16">Doctor List</span>
    </div>
            ...
            <tbody id="myTable">
                @foreach($doctors as $s)
                    <tr id='border'>
                        ...
                        <td id='border'>
                        <a href="{{route('admin.doctorProfile', $s->doctorid)}}" class="btn">Profile</a>
                        <a href="{{route('admin.doctorDeleteRequest', $s->doctorid)}}" class="delete">Delete</a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
