...
<div class="w3-content"> 
    <div class="w3-center w3-padding-64" id="login">
        <span class="w3-xlarge w3-bottombar w3-border-dark-grey w3-padding-16">Add New Doctor</span>
    </div>
    ...
    {{csrf_field()}}
        <div class="w3-section">
            <label>Name</label>
            <input type="text" name="Name" class="w3-input w3-border w3-hover-border-black" style="width:100%;" placeholder="Please First name" />
        </div>
        <div class="w3-section">
        ...
        <div class="w3-section">
            ...
            <select name="department" class="w3-input w3-border w3-hover-border-black">
        ...
        <input type="submit" name="submit" style="width:100%;" value="Add Doctor" class="btn" />
    </form>
