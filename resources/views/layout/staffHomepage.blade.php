    ...
    <tr height="15%" bgcolor="#23274C">
        ...
        <td valign="top"> <h2> <b> <font color="#CACBD5">Hospital </font><font color="white">Management System</font> </b> </h2>
            <td width="30%" valign="top" align="right">
                    <br/><br/>
                    <font color="white">Welcome, {{$user->firstname}} {{$user->lastname}} </font> <br>
            ...
            <nav>
                <ul id="main">
                    ...
                    <li>Profile
                        ...
                        <li><a href="{{route('staff.own_schedule',[$user->firstname, $user->lastname])}}" class="rmvunderline">My Schedule</a></li>
