...
<div class="w3-content"> 
    <div class="w3-center w3-padding-64" id="login">
        <span class="w3-xlarge w3-bottombar w3-border-dark-grey w3-padding-16">User List</span>
    </div>
        ...
        <table border="1" width="100%" id="myTable">
            <thead>
                <tr id='border1' class="header">
                    ...
                    <th id='border'>City</th>
                    <th id='border'>Location</th>
            ...
            <tbody id="myTable">
                @foreach($users as $s)
                    <tr id='border'>
                        <td id='border'>
                            <img src="\{{$s->picture}}" height="42" width="42">
                        </td>
                        ...
                        <td id='border'>{{$s->city}}</td>
                        <td id='border'>{{$s->location}}</td>
                        <td id='border'>
                            <a href="{{route('admin.userDestroy', $s->uid)}}" class="delete">Delete</a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
