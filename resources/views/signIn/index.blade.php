...
<div class="w3-content">  
    ...
    <form class="w3-container" method="post">
        ...
        <div class="w3-section">
            ...
            <input class="w3-input w3-border w3-hover-border-black" style="width:100%;" type="password" name="password" >
        </div>
        <input type="submit" class="w3-button w3-block w3-black" name="signIn" value="Sign In">
    </form>
